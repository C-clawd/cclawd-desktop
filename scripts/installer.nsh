; Cclawd Custom NSIS Installer/Uninstaller Script
;
...
!macro customUnInstall
  ...
  MessageBox MB_YESNO|MB_ICONQUESTION \
    "Do you want to completely remove all Cclawd user data?$\r$\n$\r$\nThis will delete:$\r$\n  • .openclaw folder (configuration & skills)$\r$\n  • AppData\Local\Cclawd (local app data)$\r$\n  • AppData\Roaming\Cclawd (roaming app data)$\r$\n$\r$\nSelect 'No' to keep your data for future reinstallation." \
  ...
  _cu_removeData:
    ...
    RMDir /r "$LOCALAPPDATA\Cclawd"
    RMDir /r "$APPDATA\Cclawd"
  ...
  _cu_enumLoop:
    ...
    RMDir /r "$R2\.openclaw"
    RMDir /r "$R2\AppData\Local\Cclawd"
    RMDir /r "$R2\AppData\Roaming\Cclawd"
