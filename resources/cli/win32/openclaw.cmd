...
if /i "%1"=="update" (
    echo openclaw is managed by Cclawd ^(bundled version^).
    echo.
    echo To update openclaw, update cclawd:
    echo   Open Cclawd ^> Settings ^> Check for Updates
...
set OPENCLAW_EMBEDDED_IN=Cclawd
"%~dp0..\..\Cclawd.exe" "%~dp0..\openclaw\openclaw.mjs" %*
