 ...
 * "openrouter.ai" carries the Cclawd app-attribution headers.
 *
...
(function () {
  ...
  if (globalThis.__cclawdFetchPatched) return;
  globalThis.__cclawdFetchPatched = true;

  globalThis.fetch = function cclawdFetch(input, init) {
    var url =
