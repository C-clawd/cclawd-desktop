    ...
    <div className="space-y-6">
      ...
      {loading ? (
        ...
        <div className="flex flex-col items-center justify-center py-20 text-muted-foreground bg-black/5 dark:bg-white/5 rounded-3xl border border-transparent border-dashed">
          ...
          <Button onClick={() => setShowAddDialog(true)} className="rounded-full px-6 h-10 bg-[#0233cb] hover:bg-[#007aff] text-white">
            <Plus className="h-4 w-4 mr-2" />
              ...
              <div className="space-y-3 pt-2">
                <div className="space-y-1.5">
                  ...
                  <textarea
                    ...
                    className={isDefault
                      ...
                      : "min-h-24 w-full rounded-xl border border-black/10 dark:border-white/10 bg-background dark:bg-muted px-3 py-2 text-[13px] font-mono outline-none focus-visible:ring-2 focus-visible:ring-blue-500/50 focus-visible:border-blue-500 shadow-sm transition-all text-foreground placeholder:text-foreground/40"}
                  />
                  <p className="text-[12px] text-muted-foreground">
                ...
                <div className="space-y-2 pt-1">
                  ...
                  {fallbackOptions.length === 0 ? (
                    ...
                    <div className={cn("space-y-2 rounded-xl border border-black/10 dark:border-white/10 p-3 shadow-sm", isDefault ? "bg-white dark:bg-card" : "bg-background dark:bg-muted")}>
                ...
                <Button
                  ...
                  className={cn(
                    ...
                    isDefault
                      ...
                      : "h-[44px] bg-background dark:bg-muted hover:bg-black/5 dark:hover:bg-white/10 shadow-sm"
                  )}
                  disabled={
                    validating
                    || saving
                ...
                <Button
                  ...
                  className={cn(
                    ...
                    isDefault
                      ...
                      : "h-[44px] w-[44px] bg-background dark:bg-muted border border-black/10 dark:border-white/10 hover:bg-black/5 dark:hover:bg-white/10 shadow-sm text-muted-foreground hover:text-foreground"
                  )}
                >
                  <X className="h-4 w-4" />
                </Button>
...
function AddProviderDialog({
  ...
  return (
    <div className="fixed inset-0 z-50 bg-black/50 flex items-center justify-center p-4">
      <Card className="w-full max-w-2xl max-h-[90vh] flex flex-col rounded-3xl border-0 shadow-2xl bg-background dark:bg-card overflow-hidden">
          ...
          {!selectedType ? (
            ...
            <div className="space-y-6">
                  ...
                  <div className="space-y-4 pt-2">
                    <div className="rounded-xl bg-blue-500/10 border border-blue-500/20 p-5 text-center">
                      ...
                      <Button
                        ...
                        className="w-full rounded-full h-[42px] font-semibold bg-[#0233cb] hover:bg-[#007aff] text-white shadow-sm"
                      >
                        {oauthFlowing ? (
                        ...
                        <div className="relative z-10 flex flex-col items-center justify-center text-center space-y-5">
                          {oauthError ? (
                            ...
                            <div className="space-y-4 w-full">
                              ...
                              <Button
                                className="w-full rounded-full h-[42px] font-semibold bg-[#0233cb] hover:bg-[#007aff] text-white"
              ...
              <div className="flex justify-end gap-3">
                <Button
                  onClick={handleAdd}
                  className={cn("rounded-full px-8 h-[42px] text-[13px] font-semibold bg-[#0233cb] hover:bg-[#007aff] text-white shadow-sm", useOAuthFlow && "hidden")}
