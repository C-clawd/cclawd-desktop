...
function formatApiError(error: unknown): string {
  ...
  if (lower.includes('cloud agent binding is not enabled')) {
    return '\u4e91\u7aef\u5ba1\u8ba1\u6a21\u5f0f\u672a\u5728 Guard Core \u4e2d\u542f\u7528\uff0c\u8bf7\u786e\u8ba4\u7535\u4fe1\u4e91 Core \u5df2\u4f7f\u7528 cloud \u6a21\u5f0f\u90e8\u7f72';
  }
  if (lower.includes('local agent binding is not enabled')) {
    return '\u5f00\u53d1\u7528\u672c\u5730\u5ba1\u8ba1\u6a21\u5f0f\u672a\u542f\u7528\uff0c\u8bf7\u5207\u6362\u5230 cloud \u6a21\u5f0f\u6216\u542f\u7528 local profile';
  }
  if (lower.includes('failed to bind guard agent')) {
    return 'Guard Core \u4e91\u7aef\u5ba1\u8ba1\u51ed\u636e\u521d\u59cb\u5316\u5931\u8d25\uff0c\u8bf7\u786e\u8ba4\u7535\u4fe1\u4e91 Core \u5df2\u542f\u7528 cloud \u6a21\u5f0f';
  }
  if (lower.includes('api key') || lower.includes('401')) {
    return 'Guard Core \u5ba1\u8ba1\u51ed\u636e\u65e0\u6548\uff0c\u8bf7\u91cd\u65b0\u542f\u52a8\u5ba1\u8ba1\u670d\u52a1\u6216\u6e05\u7406\u672c\u5730 Guard \u51ed\u636e\u540e\u91cd\u8bd5';
  }
  if (lower.includes('subscription is inactive or expired')) {
    return '\u5ba1\u8ba1\u670d\u52a1\u4ecd\u5728\u4f7f\u7528\u4f01\u4e1a\u8ba2\u9605\u6a21\u5f0f\uff0c\u8bf7\u5207\u6362\u5230 cloud \u6309\u91cf\u8ba1\u8d39\u6a21\u5f0f\u540e\u91cd\u8bd5';
  }
  if (lower.includes('no available seats')) {
    return '\u5ba1\u8ba1\u670d\u52a1\u4ecd\u5728\u68c0\u67e5\u4f01\u4e1a\u5e2d\u4f4d\uff0c\u8bf7\u5207\u6362\u5230 cloud \u6309\u91cf\u8ba1\u8d39\u6a21\u5f0f\u540e\u91cd\u8bd5';
  }
  if (lower.includes('seat is not assigned')) {
    return '\u5ba1\u8ba1\u670d\u52a1\u4ecd\u5728\u68c0\u67e5\u4f01\u4e1a\u5e2d\u4f4d\uff0c\u8bf7\u5207\u6362\u5230 cloud \u6309\u91cf\u8ba1\u8d39\u6a21\u5f0f\u540e\u91cd\u8bd5';
  }
  if (lower.includes('organization user is inactive')) {
    return '\u5ba1\u8ba1\u670d\u52a1\u4ecd\u5728\u4f7f\u7528\u4f01\u4e1a\u8d26\u53f7\u6a21\u5f0f\uff0c\u8bf7\u5207\u6362\u5230 cloud \u6a21\u5f0f\u540e\u91cd\u8bd5';
  }
  if (lower.includes('failed to login/register guard org account')) {
    return '\u5ba1\u8ba1\u670d\u52a1\u4ecd\u5728\u5c1d\u8bd5\u4f01\u4e1a\u767b\u5f55\uff0c\u8bf7\u5207\u6362\u5230 cloud \u6a21\u5f0f\u540e\u91cd\u8bd5';
  }
  if (lower.includes('invalid email or password')) {
    return '\u5ba1\u8ba1\u670d\u52a1\u4ecd\u5728\u4f7f\u7528\u4f01\u4e1a\u8ba4\u8bc1\uff0c\u8bf7\u5207\u6362\u5230 cloud \u6a21\u5f0f\u540e\u91cd\u8bd5';
  }
  if (lower.includes('missing org auth config')) {
    return '\u5ba1\u8ba1\u670d\u52a1\u4ecd\u9700\u8981\u4f01\u4e1a\u9274\u6743\u914d\u7f6e\uff0c\u8bf7\u786e\u8ba4 Guard Core \u5df2\u542f\u7528 cloud \u6a21\u5f0f';
  }
