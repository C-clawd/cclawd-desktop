    ...
    <div className="fixed inset-0 z-50 bg-black/50 flex items-center justify-center p-4" onClick={onClose}>
      <Card className="w-full max-w-lg max-h-[90vh] flex flex-col rounded-3xl border-0 shadow-2xl bg-background dark:bg-card overflow-hidden" onClick={(e) => e.stopPropagation()}>
        ...
        <CardContent className="space-y-6 pt-4 overflow-y-auto flex-1 p-6">
                  ...
                  <Button
                    ...
                    className={cn(
                      ...
                      schedule === preset.value
                        ...
                        : "bg-background dark:bg-muted border-black/10 dark:border-white/10 hover:bg-black/5 dark:hover:bg-white/5 text-foreground/80 hover:text-foreground"
                    )}
                  >
          ...
          {/* Enabled */}
          <div className="flex items-center justify-between bg-background dark:bg-muted p-4 rounded-2xl shadow-sm border border-black/5 dark:border-white/5">
            <div>
